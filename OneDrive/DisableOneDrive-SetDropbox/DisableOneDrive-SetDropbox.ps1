...
$emailConfig = @{
    ...
    From       = "yoursender@domain.com" # Update with your sender address
    To         = "receipient@recipientdomain.com" # Update with recipient address
...
"@
    ...
    $emailConfig.Credential = New-Object System.Management.Automation.PSCredential("YOURUSERNAME", $securePassword)
